    ...
    if (scannerVisible) {
      ...
      scannerRef.current
        ...
        .catch((err) => {
          ...
          setError(
            "No se pudo acceder a la cámara. Por favor, verifica los permisos e inténtalo de nuevo."
          );
        });
    }
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) {
          throw new Error(
            "Envío no encontrado. Por favor, verifica el número de seguimiento e inténtalo de nuevo."
          );
        }
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Ocurrió un error al buscar tu envío"
      );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-md mx-auto text-sm sm:text-base">
            Introduce tu número de seguimiento o escanea un código QR para
            obtener actualizaciones en tiempo real de tu envío
          </p>
        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                      <div>
                        <h2 className="text-xl font-semibold">
                          Seguimiento: {shipmentData.tracking_id}
                        </h2>
                        <p className="text-blue-100 text-sm">
                          Creado el {formatDate(shipmentData.creation_date)}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          ${
                            shipmentData.state === "DELIVERED"
                              ? "bg-green-100 text-green-800"
                              : shipmentData.state === "IN_TRANSIT"
                              ? "bg-blue-100 text-blue-800"
                              : shipmentData.state === "CREATED"
                              ? "bg-purple-100 text-purple-800"
                              : shipmentData.state === "PICKED_UP"
                              ? "bg-indigo-100 text-indigo-800"
                              : shipmentData.state === "RETURNED"
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Escanea este código QR para compartir el seguimiento
                            de este envío o acceder desde tu dispositivo móvil.
                          </p>
                          <Button
                            onClick={() => {
                              const url = `${window.location.origin}/tracking?tracking_id=${shipmentData.tracking_id}`;
                                ...
                                <div>
                                  ...
                                  <h4 className="font-medium">
                                    {pkg.package_type === "DOCUMENT"
                                      ? "Documento"
                                      : pkg.package_type === "PARCEL"
                                      ? "Paquete"
                                      : pkg.package_type === "FRAGILE"
                                      ? "Frágil"
                                      : pkg.package_type === "ELECTRONICS"
                                      ? "Electrónica"
                                      : pkg.package_type === "PERISHABLE"
                                      ? "Perecedero"
                                      : "Paquete Estándar"}
                                  </h4>
                                </div>
              ...
              !loading && (
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    No se encontró ningún envío
                  </h3>
                  <p className="text-gray-600 mb-4">
                    No pudimos encontrar ningún envío con el número de
                    seguimiento proporcionado. Por favor, verifica el número e
                    inténtalo de nuevo.
                  </p>
                  <Button

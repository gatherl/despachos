...
export default function ShipmentDetail({ shipmentId }: ShipmentDetailProps) {
        ...
        <div className="p-8 bg-red-50 border-l-4 border-red-500 text-red-700">
          <div className="flex items-center">
            ...
            <span className="font-medium">
              {error || "No se pudieron cargar los datos del envío"}
            </span>
          </div>
        </div>
      </div>
  ...
  const formattedDate = new Date(shipmentData.creation_date).toLocaleDateString(
    "es-AR",
    {
      year: "numeric",
      month: "long",
  ...
  const formattedStateDate = new Date(
    shipmentData.state_date
  ...
  const formattedEstimatedDate = estimatedDeliveryDate.toLocaleDateString(
    "es-AR",
    {
      year: "numeric",
      month: "long",
        ...
        <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-3">
              ...
              {/* Phone */}
              {(shipmentData.transportist?.cellphone ||
              ...
              <div className="pt-2">
                ...
                <div className="bg-gray-50 p-3 rounded-md text-gray-900">
                  <p>
                    {shipmentData.origin_street}{" "}
                    {shipmentData.origin_street_number}
                  </p>
                  {(shipmentData.origin_floor ||
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-3">
                ...
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  ...
                  <span className="font-medium text-gray-900">
                    {(
                      ...
                      " " +
                      (shipmentData.sender_last_name || "")
                    ).trim() || shipmentData.transportist?.name}
                  </span>
                </div>
              )}
              ...
              <div className="pt-2">
                ...
                <div className="bg-gray-50 p-3 rounded-md text-gray-900">
                  <p>
                    {shipmentData.destination_street}{" "}
                    {shipmentData.destination_street_number}
                  </p>
                  {(shipmentData.destination_floor ||
                  ...
                  <p>
                    ...
                    {shipmentData.destination_zip_code}
                  </p>
                </div>
              </div>
            </div>
